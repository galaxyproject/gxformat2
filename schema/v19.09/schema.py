...
This field specifies the location of the step's node when rendered in the workflow editor.
    ...
    @classmethod
    def fromDoc(cls, doc, baseuri, loadingOptions, docRoot=None):
        # type: (Any, Text, LoadingOptions, Optional[Text]) -> StepPosition
...
class ToolShedRepository(Savable):
    ...
    @classmethod
    def fromDoc(cls, doc, baseuri, loadingOptions, docRoot=None):
        # type: (Any, Text, LoadingOptions, Optional[Text]) -> ToolShedRepository
...
class WorkflowInputParameter(InputParameter):
    ...
    @classmethod
    def fromDoc(cls, doc, baseuri, loadingOptions, docRoot=None):
        # type: (Any, Text, LoadingOptions, Optional[Text]) -> WorkflowInputParameter
...
Workflow step.
    ...
    def fromDoc(cls, doc, baseuri, loadingOptions, docRoot=None):
        ...
        for k in _doc.keys():
            if k not in cls.attrs:
                if ":" in k:
                    ...
                    errors.append(
                        ValidationException(
                            "invalid field `%s`, expected one of: `id`, `label`, `doc`, `position`, `tool_id`, `tool_shed_repository`, `tool_version`, `in`, `out`, `type`" % (k),
                            SourceLine(_doc, k, str)
                        )
                    )
                    break
        ...
        loadingOptions = copy.deepcopy(loadingOptions)
        loadingOptions.original_doc = _doc
        return cls(id, label, doc, position, tool_id, tool_shed_repository, tool_version, in_, out, type, extension_fields=extension_fields, loadingOptions=loadingOptions)
    ...
    attrs = frozenset([u'id', u'label', u'doc', u'position', u'tool_id', u'tool_shed_repository', u'tool_version', u'in', u'out', u'type'])
...
This is documentation for a workflow!
    ...
    @classmethod
    def fromDoc(cls, doc, baseuri, loadingOptions, docRoot=None):
        # type: (Any, Text, LoadingOptions, Optional[Text]) -> GalaxyWorkflow
        ...
        loadingOptions = copy.deepcopy(loadingOptions)
        loadingOptions.original_doc = _doc
        return cls(id, label, doc, inputs, outputs, name, steps, extension_fields=extension_fields, loadingOptions=loadingOptions)
...
_vocab = {
    ...
    "File": "https://galaxyproject.org/gxformat2/v19.09#GalaxyType/File",
    "GalaxyType": "https://galaxyproject.org/gxformat2/v19.09#GalaxyType",
    "GalaxyWorkflow": "https://galaxyproject.org/gxformat2/v19.09#GalaxyWorkflow",
    ...
    "Sink": "https://galaxyproject.org/gxformat2/v19.09#Sink",
    ...
    "WorkflowInputParameter": "https://galaxyproject.org/gxformat2/v19.09#WorkflowInputParameter",
    "WorkflowOutputParameter": "https://galaxyproject.org/gxformat2/v19.09#WorkflowOutputParameter",
    "WorkflowStep": "https://galaxyproject.org/gxformat2/v19.09#WorkflowStep",
    "WorkflowStepInput": "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepInput",
    "WorkflowStepOutput": "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepOutput",
    "WorkflowStepType": "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepType",
    "array": "https://w3id.org/cwl/salad#array",
    "boolean": "http://www.w3.org/2001/XMLSchema#boolean",
    "collection": "https://galaxyproject.org/gxformat2/v19.09#GalaxyType/collection",
    "data": "https://galaxyproject.org/gxformat2/v19.09#GalaxyType/data",
    ...
    "pause": "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepType/pause",
    "record": "https://w3id.org/cwl/salad#record",
    "string": "http://www.w3.org/2001/XMLSchema#string",
    "subworkflow": "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepType/subworkflow",
    "tool": "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepType/tool",
}
_rvocab = {
    ...
    "https://galaxyproject.org/gxformat2/v19.09#GalaxyType/File": "File",
    "https://galaxyproject.org/gxformat2/v19.09#GalaxyType": "GalaxyType",
    "https://galaxyproject.org/gxformat2/v19.09#GalaxyWorkflow": "GalaxyWorkflow",
    ...
    "https://galaxyproject.org/gxformat2/v19.09#Sink": "Sink",
    ...
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowInputParameter": "WorkflowInputParameter",
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowOutputParameter": "WorkflowOutputParameter",
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowStep": "WorkflowStep",
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepInput": "WorkflowStepInput",
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepOutput": "WorkflowStepOutput",
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepType": "WorkflowStepType",
    "https://w3id.org/cwl/salad#array": "array",
    "http://www.w3.org/2001/XMLSchema#boolean": "boolean",
    "https://galaxyproject.org/gxformat2/v19.09#GalaxyType/collection": "collection",
    "https://galaxyproject.org/gxformat2/v19.09#GalaxyType/data": "data",
    ...
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepType/pause": "pause",
    "https://w3id.org/cwl/salad#record": "record",
    "http://www.w3.org/2001/XMLSchema#string": "string",
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepType/subworkflow": "subworkflow",
    "https://galaxyproject.org/gxformat2/v19.09#WorkflowStepType/tool": "tool",
}
...
GalaxyTypeLoader = _EnumLoader(("File", "data", "collection",))
