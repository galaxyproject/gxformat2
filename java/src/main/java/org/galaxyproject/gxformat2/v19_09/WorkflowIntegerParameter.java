 ...
 * This interface is implemented by {@link WorkflowIntegerParameterImpl}<br>
 */
public interface WorkflowIntegerParameter extends BaseInputParameter, MinMax, Saveable {
  /**
