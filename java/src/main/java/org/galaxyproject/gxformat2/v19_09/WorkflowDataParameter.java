 ...
 * This interface is implemented by {@link WorkflowDataParameterImpl}<br>
 */
public interface WorkflowDataParameter extends BaseDataParameter, Saveable {
  /**
  ...
  java.util.Optional<GalaxyDataType> getType();
}
