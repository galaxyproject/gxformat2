 ...
 */
public class WorkflowTextParameterImpl extends SaveableImpl implements WorkflowTextParameter {
  ...
  private java.util.Optional<java.util.List<Object>> validators;
   ...
   */
  public WorkflowTextParameterImpl(
      final Object __doc_,
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("WorkflowTextParameterImpl called on non-map");
    }
    ...
    try {
      type =
          LoaderInstances.typedsl_union_of_GalaxyTextType_or_array_of_WorkflowTextParameter_2
    ...
    java.util.Optional<java.util.List<Object>> validators;

    if (__doc.containsKey("validators")) {
      try {
        validators =
            LoaderInstances.optional_array_of_TextValidators.loadField(
                __doc.get("validators"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
        validators = null; // won't be used but prevents compiler from complaining.
        final String __message = "the `validators` field is not valid because:";
        __errors.add(new ValidationException(__message, e));
      }
    ...
    this.validators = (java.util.Optional<java.util.List<Object>>) validators;
  }
}
