 ...
 * <I>https://galaxyproject.org/gxformat2/v19_09#BaseInputParameter</I><br>
 */
public class BaseInputParameterImpl extends SaveableImpl implements BaseInputParameter {
  ...
  public BaseInputParameterImpl(
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("BaseInputParameterImpl called on non-map");
    }
