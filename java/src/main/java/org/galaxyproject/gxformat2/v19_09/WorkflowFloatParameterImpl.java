 ...
 * <I>https://galaxyproject.org/gxformat2/v19_09#WorkflowFloatParameter</I><br>
 */
public class WorkflowFloatParameterImpl extends SaveableImpl implements WorkflowFloatParameter {
   ...
   */
  public WorkflowFloatParameterImpl(
      final Object __doc_,
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("WorkflowFloatParameterImpl called on non-map");
    }
    ...
    try {
      type =
          LoaderInstances.typedsl_union_of_GalaxyFloatType_or_array_of_WorkflowFloatParameter_2
