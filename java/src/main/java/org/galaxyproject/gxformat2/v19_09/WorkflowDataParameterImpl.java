 ...
 * <I>https://galaxyproject.org/gxformat2/v19_09#WorkflowDataParameter</I><br>
 */
public class WorkflowDataParameterImpl extends SaveableImpl implements WorkflowDataParameter {
  ...
  private java.util.Optional<GalaxyDataType> type;

  /** Getter for property <I>https://w3id.org/cwl/salad#type</I><br> */
  public java.util.Optional<GalaxyDataType> getType() {
    return this.type;
  }

  /**
   * Used by {@link org.galaxyproject.gxformat2.v19_09.utils.RootLoader} to construct instances of
   * WorkflowDataParameterImpl.
   *
   ...
   */
  public WorkflowDataParameterImpl(
      final Object __doc_,
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("WorkflowDataParameterImpl called on non-map");
    }
    ...
    java.util.Optional<GalaxyDataType> type;

    if (__doc.containsKey("type")) {
      try {
        type =
            LoaderInstances.typedsl_optional_GalaxyDataType_2.loadField(
    ...
    this.type = (java.util.Optional<GalaxyDataType>) type;
  }
}
