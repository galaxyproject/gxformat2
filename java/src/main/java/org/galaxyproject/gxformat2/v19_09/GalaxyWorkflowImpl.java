...
/**
* Auto-generated class implementation for <I>https://galaxyproject.org/gxformat2/v19_09#GalaxyWorkflow</I><BR> <BLOCKQUOTE>
...
public class GalaxyWorkflowImpl extends SavableImpl implements GalaxyWorkflow {
   ...
   * <BLOCKQUOTE>
   * Workflow invocation report template.   * </BLOCKQUOTE>
   */
  ...
  /**
   * Used by {@link org.galaxyproject.gxformat2.v19_09.utils.RootLoader} to construct instances of GalaxyWorkflowImpl.
   *
    ...
    if (__doc.containsKey("report")) {
      try {
        report =
            LoaderInstances
                .optional_Report
                .loadField(__doc.get("report"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
      ...
      try {
        tags =
            LoaderInstances
                ...
                .loadField(__doc.get("tags"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
