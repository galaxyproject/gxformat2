 ...
 * This interface is implemented by {@link WorkflowCollectionParameterImpl}<br>
 */
public interface WorkflowCollectionParameter extends BaseDataParameter, Saveable {
  /**
  ...
  GalaxyDataCollectionType getType();
  /**
   * Getter for property
