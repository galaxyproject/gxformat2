...
/**
* Auto-generated class implementation for <I>https://galaxyproject.org/gxformat2/v19_09#WorkflowStep</I><BR> <BLOCKQUOTE>
...
public class WorkflowStepImpl extends SavableImpl implements WorkflowStep {
  ...
  /**
   * Used by {@link org.galaxyproject.gxformat2.v19_09.utils.RootLoader} to construct instances of WorkflowStepImpl.
   *
  ...
  public WorkflowStepImpl(
    ...
    if (__doc.containsKey("tool_id")) {
      try {
        tool_id =
            LoaderInstances
                .optional_StringInstance
                .loadField(__doc.get("tool_id"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("tool_shed_repository")) {
      try {
        tool_shed_repository =
            LoaderInstances
                .optional_ToolShedRepository
                .loadField(__doc.get("tool_shed_repository"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("tool_version")) {
      try {
        tool_version =
            LoaderInstances
                .optional_StringInstance
                .loadField(__doc.get("tool_version"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("errors")) {
      try {
        errors =
            LoaderInstances
                .optional_StringInstance
                .loadField(__doc.get("errors"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("uuid")) {
      try {
        uuid =
            LoaderInstances
                .optional_StringInstance
                .loadField(__doc.get("uuid"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
      ...
      try {
        state =
            LoaderInstances
                ...
                .loadField(__doc.get("state"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("tool_state")) {
      try {
        tool_state =
            LoaderInstances
                .optional_AnyInstance
                .loadField(__doc.get("tool_state"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
    ...
    if (__doc.containsKey("type")) {
      try {
        type =
            LoaderInstances
                .typedsl_optional_WorkflowStepType_2
      ...
      try {
        runtime_inputs =
            LoaderInstances
                ...
                .loadField(__doc.get("runtime_inputs"), __baseUri, __loadingOptions);
      } catch (ValidationException e) {
