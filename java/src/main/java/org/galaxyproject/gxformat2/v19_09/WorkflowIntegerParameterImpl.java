 ...
 * <I>https://galaxyproject.org/gxformat2/v19_09#WorkflowIntegerParameter</I><br>
 */
public class WorkflowIntegerParameterImpl extends SaveableImpl implements WorkflowIntegerParameter {
   ...
   */
  public WorkflowIntegerParameterImpl(
      final Object __doc_,
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("WorkflowIntegerParameterImpl called on non-map");
    }
    ...
    try {
      type =
          LoaderInstances.typedsl_union_of_GalaxyIntegerType_or_array_of_WorkflowIntegerParameter_2
