 ...
 * <I>https://galaxyproject.org/gxformat2/v19_09#WorkflowCollectionParameter</I><br>
 */
public class WorkflowCollectionParameterImpl extends SaveableImpl
    implements WorkflowCollectionParameter {
  ...
  private GalaxyDataCollectionType type;

  /** Getter for property <I>https://w3id.org/cwl/salad#type</I><br> */
  public GalaxyDataCollectionType getType() {
    return this.type;
  }
  ...
  /**
   * Getter for property
   * <I>https://galaxyproject.org/gxformat2/v19_09#WorkflowCollectionParameter/collection_type</I>
   * <br>
   *
   * <BLOCKQUOTE>
   *
   ...
   * WorkflowCollectionParameterImpl.
   *
   ...
   */
  public WorkflowCollectionParameterImpl(
      final Object __doc_,
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("WorkflowCollectionParameterImpl called on non-map");
    }
    ...
    GalaxyDataCollectionType type;
    try {
      type =
          LoaderInstances.typedsl_GalaxyDataCollectionType_2.loadField(
    ...
    this.type = (GalaxyDataCollectionType) type;
