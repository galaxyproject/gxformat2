 ...
 * 
 */
export class Report extends Saveable {
  ...
  constructor ({extensionFields, loadingOptions, markdown} : {extensionFields?: Dictionary<any>, loadingOptions?: LoadingOptions,  markdown: string,}) {
    super()
  ...
  static override async fromDoc (__doc: any, baseuri: string, loadingOptions: LoadingOptions,
    ...
    if (errors.length > 0) {
      throw new ValidationException("Trying 'Report'", errors)
    }
