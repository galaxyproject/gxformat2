 ...
 */
export class ToolShedRepository extends Saveable {
  ...
  constructor ({extensionFields, loadingOptions, name, changeset_revision, owner, tool_shed} : {extensionFields?: Dictionary<any>, loadingOptions?: LoadingOptions,  changeset_revision: string, name: string, owner: string, tool_shed: string,}) {
    super()
