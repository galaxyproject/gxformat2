...
export async function loadDocument (doc: any, baseuri?: string, loadingOptions?: LoadingOptions): Promise<Internal.GalaxyWorkflow | Array<Internal.GalaxyWorkflow>> {
  if (baseuri == null) {
  ...
  return await documentLoad(LoaderInstances.unionOfGalaxyWorkflowLoaderOrarrayOfunionOfGalaxyWorkflowLoader, doc, baseuri, loadingOptions)
}

export async function loadDocumentByString (doc: string, uri: string, loadingOptions?: LoadingOptions): Promise<Internal.GalaxyWorkflow | Array<Internal.GalaxyWorkflow>> {
  ...
  return await documentLoad(LoaderInstances.unionOfGalaxyWorkflowLoaderOrarrayOfunionOfGalaxyWorkflowLoader, result, uri, loadingOptions)
}
