 ...
 * 
 */
export class WorkflowStep extends Saveable implements Internal.Identified, Internal.Labeled, Internal.Documented, Internal.HasStepPosition, Internal.ReferencesTool, Internal.HasStepErrors, Internal.HasUUID {
