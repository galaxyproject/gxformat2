...
extensions = ["myst_parser", "sphinx.ext.autodoc", "sphinx.ext.intersphinx", "sphinx.ext.viewcode", "sphinxarg.ext", "examples_catalog"]
...
# [howto/manual]).
latex_documents = [
    ("index", "gxformat2.tex", "gxformat2 Documentation", "Galaxy Project and Community", "manual"),
]
